...
namespace EBA
{
    ...
    internal sealed class Numalet
    {
        ...
        internal const String SeparadorDecimalSalidaDefault = "con";
        internal const String MascaraSalidaDecimalDefault = "00'/100.-'";
        internal const Int32 DecimalesDefault = 2;
        internal const Boolean LetraCapitalDefault = true;
        internal const Boolean ConvertirDecimalesDefault = false;
        internal const Boolean ApocoparUnoParteEnteraDefault = false;
        internal const Boolean ApocoparUnoParteDecimalDefault = false;
        ...
        /// </summary>
        internal String SeparadorDecimalSalida
        {
        ...
        /// </summary>
        internal String MascaraSalidaDecimal
        {
            get
            {
        ...
        /// </summary>
        internal Boolean ConvertirDecimales
        {
        ...
        /// </summary>
        internal Boolean ApocoparUnoParteEntera
        {
        ...
        internal Boolean ApocoparUnoParteDecimal
        {
        ...
        internal Numalet(Boolean ConvertirDecimales, String MascaraSalidaDecimal, String SeparadorDecimalSalida, Boolean LetraCapital)
        {
        ...
        internal String ToCustomCardinal(float Numero)
        ...
        internal String ToCustomCardinal(String Numero)
        {
            float dNumero;
            if (float.TryParse(Numero, NumberStyles.Float, _cultureInfo, out dNumero))
                return ToCustomCardinal(dNumero);
            else throw new ArgumentException("'" + Numero + "' no es un número válido.");
        }

        internal String ToCustomCardinal(Decimal Numero)
        { return ToCardinal((Numero)); }

        internal String ToCustomCardinal(Int32 Numero)
        ...
        internal static String ToCardinal(Int32 Numero)
        {
        ...
        internal static String ToCardinal(float Numero)
        {
            return ToCardinal((Decimal)Numero);
        }

        internal static String ToCardinal(String Numero, CultureInfo ReferenciaCultural)
        {
            float dNumero;
            if (float.TryParse(Numero, NumberStyles.Float, ReferenciaCultural, out dNumero))
                return ToCardinal(dNumero);
            else throw new ArgumentException("'" + Numero + "' no es un número válido.");
        }

        internal static String ToCardinal(String Numero)
        {
            return Numalet.ToCardinal(Numero, CultureInfo.CurrentCulture);
        }

        internal static String ToCardinal(Decimal Numero)
        {
        ...
        private static String Convertir(Decimal Numero, Int32 Decimales, String SeparadorDecimalSalida, String MascaraSalidaDecimal, Boolean EsMascaraNumerica, Boolean LetraCapital, Boolean ConvertirDecimales, Boolean ApocoparUnoParteEntera, Boolean ApocoparUnoParteDecimal)
        {
            ...
            if (Decimales > 0)
            {
                ...
                Int32 EnteroDecimal = (Int32)Math.Round((float)(Numero - (Int64)Numero) * Math.Pow(10, Decimales), 0);
